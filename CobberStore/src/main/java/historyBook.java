...
public class historyBook extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("History Book");

        returnButton4.setBackground(new java.awt.Color(255, 204, 0));
        ...
        jLabel2.setText("Pocket Guide To Writing In History");

        jLabel3.setText("$40.00");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(historyBook.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
